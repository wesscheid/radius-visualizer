  ...
  return (
    <>
      ...
      <div className={clsx(
        ...
        "h-[50vh] md:h-full w-full md:w-80 bg-white shadow-xl z-10",
        "flex flex-col transition-transform duration-300 rounded-t-2xl md:rounded-none",
        ...
        <div className="p-4 border-b border-gray-200 bg-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className={clsx(
                "p-3 md:p-2 rounded-full transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center",
          ...
          <form onSubmit={handleCreateGroup} className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-3 md:py-2 text-base md:text-sm border border-gray-300 rounded focus:outline-none focus:border-primary"
            />
            <button 
              type="submit"
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-gray-50 pb-20 md:pb-4">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 mb-4">
              ...
              <div className="bg-white rounded p-2 border border-slate-100 shadow-sm">
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-between text-xs font-medium text-slate-500 hover:text-slate-700 py-2 border-t border-slate-100 mt-1 pt-1 min-h-[30px]"
                >
                ...
                <div className="mt-3 flex gap-2 border-t border-slate-100 pt-3">
                  <button 
                    ...
                    className="flex-1 flex items-center justify-center gap-1 text-[10px] font-bold bg-slate-100 text-slate-600 hover:bg-slate-200 py-2 rounded transition-colors"
                  >
              ...
              <div className="p-3 bg-gray-100 flex items-center justify-between border-b border-gray-200">
                ...
                <div className="flex items-center gap-1">
                  <button 
                    ...
                    className="p-2 md:p-1 text-gray-400 hover:text-gray-600 rounded min-h-[44px] min-w-[44px] md:min-h-0 md:min-w-0 flex items-center justify-center"
                  >
                    {group.visible ? <Eye size={16} /> : <EyeOff size={16} />}
                  </button>
                  <button 
                    onClick={() => removeGroup(group.id)}
                    className="p-2 md:p-1 text-gray-400 hover:text-danger rounded min-h-[44px] min-w-[44px] md:min-h-0 md:min-w-0 flex items-center justify-center"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
            ...
            <div className="space-y-2">
              {getGroupedRadii(null).map(radius => (
                <div 
                  ...
                  onClick={() => selectRadius(radius.id)}
                  className={clsx(
                    "bg-white rounded-lg p-3 shadow-sm border-2 cursor-pointer transition-all min-h-[60px]",
        ...
        {selectedRadius && (
          <div className="hidden md:block p-4 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
             <EditPanel 
      ...
      {selectedRadius && (
        <div className="md:hidden fixed inset-0 z-50 flex flex-col justify-end bg-black/20 backdrop-blur-sm" onClick={() => selectRadius(null)}>
          <div 
            className="bg-white rounded-t-2xl shadow-2xl max-h-[85vh] overflow-y-auto w-full animate-in slide-in-from-bottom duration-300"
          ...
          >
            ...
            <div className="p-5 pb-8">
              <div className="flex justify-between items-center mb-4">
                 <h3 className="font-bold text-lg text-gray-800">Edit Location</h3>
                 <button onClick={() => selectRadius(null)} className="text-sm text-blue-600 font-semibold px-2 py-1">Done</button>
              </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <input 
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary text-base md:text-sm"
        />
      </div>
      ...
      <div>
        ...
        <textarea 
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary text-base md:text-sm min-h-[80px] md:min-h-[60px] resize-y"
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary text-base md:text-sm bg-white"
        >
      ...
      <div className="flex gap-3">
        <div className="flex-1">
          ...
          <input 
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary text-base md:text-sm font-mono"
          />
        </div>
        <div className="flex-1">
      ...
      <div>
          ...
          <div className="flex-1">
            <div className="relative">
              <input 
                ...
                className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary text-base md:text-sm font-mono"
              />
              <span className="absolute right-3 top-2.5 text-[10px] text-gray-400 font-bold uppercase">mi</span>
            </div>
          </div>
          <div className="flex-1">
            <div className="relative">
              <input 
                ...
                className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary text-base md:text-sm font-mono"
              />
              <span className="absolute right-3 top-2.5 text-[10px] text-gray-400 font-bold uppercase">ft</span>
            </div>
          </div>
        </div>
        ...
        <input 
          ...
          className="w-full h-4 md:h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
        />
          ...
          {!selectedRadius.groupId && (
            <div>
              ...
              <input 
                ...
                className="h-10 w-10 md:h-8 md:w-8 p-0 border-0 rounded cursor-pointer"
              />
            </div>
          )}
          {selectedRadius.groupId && (
      ...
      <div className="flex items-center gap-2 mt-2">
          <label className="flex items-center gap-3 text-sm text-gray-600 cursor-pointer min-h-[44px]">
              <input 
                  type="checkbox"
